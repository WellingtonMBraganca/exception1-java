...
import entities.domain.Vehicle;
...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("Pagamento basico: " + String.format("%.2f",
                cr.getInvoive().getBasicPayment()));
        System.out.println("Imposto: " + String.format("%.2f", cr.getInvoive().getTax()));
        System.out.println("Pagamento total: " + String.format("%.2f", cr.getInvoive().totalPayment()));
